...
const translations = {
  en: {
    ...
    hero: {
      ...
      deploy: "Deploy Agent",
      docs: "Try a Micro-Skill"
    },
    micro: {
      eyebrow: "Micro-Skill",
      title: "One-Prompt Card",
      desc: "Describe yourself in one sentence and watch MOFANG AI turn it into a stylized digital business card with visible agent logs.",
      placeholder: "Describe yourself in one sentence. Example: I'm Kevin, a full-stack developer who loves dark hacker aesthetics, email kevin@mofang.ai...",
      generate: "Generate Card",
      consoleIdle: "> Waiting for prompt...",
      log1: "> [NLP] Extracting identity entities...done",
      log2: "> [Style] Matching visual intent...tech noir selected",
      log3: "> [UI Engine] Building wallet-style components...done",
      log4: "> [Renderer] Final card generated successfully (0.8s)",
      fallback: "> [Fallback] Model unavailable, local parser used",
      cardLabel: "Generated Card",
      cardHint: "Tap the name to correct it instantly if the model reads it wrong.",
      nameFallback: "Tap to enter your name",
      roleFallback: "Role Pending",
      companyFallback: "Studio / Company pending",
      previewEmpty: "Run the micro-skill to generate a live business card preview.",
      downloadPng: "Download PNG",
      downloadSvg: "Download SVG",
      copyLink: "Copy Card Link",
      qrTitle: "QR Card Link",
      qrDesc: "Share this smart card page link or let someone scan the QR code to open it instantly.",
      linkCopied: "> [Share] Card link copied to clipboard",
      cta: "Explore Enterprise Workflow",
      reset: "Use Example Prompt"
    },
    intro: {
    ...
    ops: {
      ...
      inboxLeads: "Leads",
      inboxChats: "Chats",
      shareTitle: "Shared card analytics",
      shareDesc: "Track opens and interaction events from generated electronic business card links.",
      shareEmpty: "No share events yet.",
  ...
  zh: {
    ...
    micro: {
      eyebrow: "微技能",
      title: "一语成片",
      desc: "用一句自然语言介绍你自己，让魔方AI把它转成一张有风格、有排版、有过程可视化的电子名片。",
      placeholder: "用一句话描述你自己。示例：我是 Kevin，全栈开发者，偏爱暗黑极客风，邮箱 kevin@mofang.ai，微信 kevinlab。",
      generate: "生成名片",
      consoleIdle: "> 等待输入意图...",
      log1: "> [NLP] 提取实体特征...完成",
      log2: "> [Style] 识别风格意图...已匹配科技暗色主题",
      log3: "> [UI Engine] 正在渲染 Wallet 风格组件...",
      log4: "> [Renderer] 名片生成成功 (0.8s)",
      fallback: "> [Fallback] 模型不可用，已启用本地解析兜底",
      cardLabel: "生成结果",
      cardHint: "点按名字可直接纠错，前端会即时更新。",
      nameFallback: "点击输入姓名",
      roleFallback: "职位待确认",
      companyFallback: "公司 / 团队待确认",
      previewEmpty: "运行这个微技能后，这里会出现一张可编辑的名片预览。",
      downloadPng: "下载 PNG",
      downloadSvg: "下载 SVG",
      copyLink: "复制名片链接",
      qrTitle: "二维码名片链接",
      qrDesc: "可直接分享这个电子名片页链接，或让对方扫码打开。",
      linkCopied: "> [Share] 名片链接已复制到剪贴板",
      cta: "了解企业级定制方案",
      reset: "使用示例提示词"
    },
    intro: {
    ...
    ops: {
      ...
      inboxChats: "客服对话",
      shareTitle: "电子名片行为记录",
      shareDesc: "查看分享名片页的打开、点击和继续咨询等行为埋点。",
      shareEmpty: "暂时还没有名片行为记录。",
