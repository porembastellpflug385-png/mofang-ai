...
const translations = {
  en: {
    ...
    ecosystem: {
      ...
      card1_desc: "Publish your vertical workflows (e.g., Logo & VI Generator) to the platform.",
    ...
    ops: {
      ...
      chatTitle: "Smart support inbox",
      chatDesc: "Visitors can chat with the AI assistant, and your team receives each message immediately.",
  ...
  zh: {
    ...
    ecosystem: {
      ...
      card1_desc: "开发者可将封装好的垂直工作流（如 Logo 与品牌 VI 生成器）发布到平台。",
      card2_title: "创作者经济",
    ...
    ops: {
      ...
      mailButton: "立即发送邮件",
      chatTitle: "智能客服收件箱",
      chatDesc: "访客可直接与 AI 助手对话，团队也能同步看到每一条留言。",
