...
export default function Hero({ onOpenMicroSkill }: { onOpenMicroSkill: () => void }) {
  ...
  return (
    <section id="top" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 md:pt-20">
      {/* Background glow */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-center text-center">
        <motion.h1 
          ...
          className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-semibold tracking-tighter mb-6"
        >
        ...
        <motion.p 
          ...
          className="text-base md:text-xl text-zinc-400 max-w-3xl mb-10 font-light leading-relaxed"
        >
          {t('hero.desc')}
        </motion.p>
